...
const SortDrawer = ({
	...
	return (
		...
		>
			<button
				onClick={handleOpen}
				className="text-typo-secondary text-xs font-medium font-saira flex items-center w-full justify-between p-3 border border-solid border-divider-secondary rounded"
			>
				{sort?.label || "Default"}
				<ChevronIcon />
			</button>
