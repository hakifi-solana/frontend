        ...
        <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="main" className="rounded border data-[state=closed]:border-transparent data-[state=open]:border-divider-primary">
                <AccordionTrigger className={
                    cn("[&[data-state=open]>div]:rotate-180 [&[data-state=closed]>div]:rounded-tl [&[data-state=closed]>div]:border-t [&[data-state=closed]>div]:border-l [&[data-state=closed]>div]:border-divider-secondary [&[data-state=open]>div]:rounded-br [&[data-state=open]>div]:border-r [&[data-state=open]>div]:border-b [&[data-state=open]>div]:border-divider-primary flex justify-between",
