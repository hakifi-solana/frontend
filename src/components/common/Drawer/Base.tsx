...
>(({ className, ...props }, ref) => (
    <DrawerPrimitive.Overlay
        ref={ref}
        className={cn("fixed inset-0 z-20 bg-background-scrim/30 backdrop-blur-[15px]", className)}
        {...props}
    />
));
...
>(({ className, children, overlay = true, ...props }, ref) => (
    <DrawerPortal>
        ...
        <DrawerPrimitive.Content
            ref={ref}
            className={cn(
                "fixed inset-x-0 bottom-0 z-40 flex h-fit flex-col bg-background-tertiary p-4 pb-8 max-h-fit-screen overflow-auto custom-scroll after:!content-none",
                className
            )}
            {...props}
        >
