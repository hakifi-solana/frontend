    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                caption_label: "sub-heading-mobile text-typo-primary",
                ...
                day_selected:
                    "bg-background-secondary text-typo-accent rounded border first:[&:has([aria-selected])]:border-typo-accent last:[&:has([aria-selected])]:border-typo-accent",
            ...
            components={{
                IconLeft: ({ ...props }) => <ChevronIcon className="size-6 rotate-90" />,
                IconRight: ({ ...props }) => <ChevronIcon className="size-6 -rotate-90" />,
            }}
            {...props}
        />
    );
