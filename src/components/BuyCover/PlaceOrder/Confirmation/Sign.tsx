        ...
        <div className="flex flex-col items-center gap-5">
            ...
            <section className="border border-divider-secondary p-4 flex flex-col gap-3 rounded">
                <p className="text-body-14 text-typo-secondary">
                    (*) Actual Open Price does not exceed 0.3% compared to Market Price at the time of pressing "Confirm".
                </p>
                <p className="text-body-14 text-typo-secondary">
                    (**) While the insurance contract is being validated, please do not press “Refresh”
                </p>
            </section>
        </div>
    );
