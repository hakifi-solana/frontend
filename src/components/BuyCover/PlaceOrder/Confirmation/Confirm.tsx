...
const StepConfirm = ({ pair, setStep, onCloseModal }: StepConfirmProps) => {
  ...
  return (
    <div className="flex flex-col gap-5">
      <p className="text-title-24 text-typo-primary">
        Cover margin information
      </p>
      <section className="border-divider-secondary flex flex-col gap-4 border p-4 rounded bg-support-black">
        <div className="flex items-center justify-between">
          <TooltipCustom
            ...
            title={
              <p className="border-typo-secondary border-b border-dashed">
                Period
              </p>
            }
            showArrow={true}
      ...
      <section className="flex flex-col gap-2">
        <p className="text-body-14 text-typo-secondary">
          (*) Margin refund conditions: On T-Expire day, P-Market is between the
          P-Refund and P-Claim zones.
        </p>
        <p className="text-body-14 text-typo-secondary">
      ...
      <p className="text-body-14 text-typo-secondary text-center">
        ...
        <span className="text-typo-accent">Hakifi's Term of Service</span>
      </p>
    </div>
  );
};
