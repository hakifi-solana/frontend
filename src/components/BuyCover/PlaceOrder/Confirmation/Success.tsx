        ...
        <div className="flex flex-col justify-center items-center gap-5">
            ...
            <section className="text-title-24 text-center">
                <p className="text-typo-primary">
                    Contract <span className={cn(side === ENUM_INSURANCE_SIDE.BULL ? "text-positive" : "text-negative")}>{asset} {side}</span>
                </p>
                <p className="text-typo-primary">
                    successfully margin <span className="text-positive">{formatNumber(margin)} USDT</span>
                </p>
            </section>
            <section className="border border-divider-secondary rounded flex flex-col gap-3 p-4 w-full">
                ...
                <div className="flex items-center justify-between">
                    <TooltipCustom
                        ...
                        title={<p className="border-b border-dashed border-typo-secondary text-body-14">
                            Q-Claim
                        </p>}
                        showArrow={true}
                    />
                    ...
                    <section className="flex flex-col gap-4">
                        <div className="flex items-center justify-between">
                            <TooltipCustom
                                content={""}
                                titleClassName="text-typo-secondary"
                                title={<p className="border-b border-dashed border-typo-secondary">
                                    Q-Cover
                                </p>}
                                showArrow={true}
                            />
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-body-14">
                                <span className="text-typo-primary">{formatNumber(p_claim)} USDT    <span className="text-typo-accent">({formatNumber(pr_claim)}%)
                                </span>
                                </span>
                        ...
                        <div className="flex items-center justify-between">
                            <p className="text-typo-secondary text-body-14">
                                Duration
                            </p>
