...
const AdjustMargin = forwardRef<HTMLInputElement, AdjustMarginInputProps>(
    (
        ...
        const [p_claim, q_covered, hedge, periodChangeRatio, periodUnit, q_claim] = useBuyCoverStore(
            (state) => [
                state.p_claim,
                state.q_covered,
                state.hedge,
        ...
        const descriptionMessage = useMemo(() => {
            ...
            return "~ " + formatNumber(percent) + "% of Cover amount";
        }, [margin]);
            ...
            return <Drawer open={toggle} modal={true}>
                ...
                <DrawerContent onInteractOutside={handleCloseModal} className="!z-[60]">
                    <DrawerHeader>
                        ...
                        <DrawerTitle className="!text-title-20 text-typo-primary my-5">Custom Margin</DrawerTitle>
                    </DrawerHeader>
                    <>
                        <FormInputNumber
                            ref={forwardRef}
                        ...
                        <div className="mt-10 flex flex-col gap-4 border border-divider-secondary p-4 bg-support-black rounded">
                            <div className="flex items-center justify-between gap-1 text-body-14">
                                <p className="text-body-14 text-typo-secondary">Avaiable</p>
                                <p className="text-body-14 text-typo-primary">
                                    {formatNumber(balance)} USDT
                                </p>
                            </div>
                            <div className="text-body-14Ư flex items-center justify-between gap-1 ">
                                <TooltipCustom
                                    content="Q-Claim"
                    ...
                    <div className="!mt-10 flex flex-col gap-4 border border-divider-secondary p-4 bg-support-black rounded">
                        ...
                        <div className="text-body-14 flex items-center justify-between gap-1 ">
                            <TooltipCustom
                                content="Q-Claim"
                                titleClassName="text-typo-primary"
                                title={<p className="border-b border-dashed border-typo-secondary text-typo-secondary">
                                    Q-Claim
                                </p>}
                                showArrow={true}
                            />
