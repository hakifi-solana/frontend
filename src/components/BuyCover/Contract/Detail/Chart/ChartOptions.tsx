                ...
                <Tabs className="w-full">
                    <TabsList className="grid w-full grid-cols-7 gap-2">
                        {listTimeFrame.map((t: Resolution) => <TabsTrigger
                            ...
                            className={cn("h-fit !text-body-14 hover:bg-background-secondary hover:text-typo-accent hover:border-typo-accent px-2.5 py-1 text-typo-secondary border border-divider-secondary rounded-sm",
